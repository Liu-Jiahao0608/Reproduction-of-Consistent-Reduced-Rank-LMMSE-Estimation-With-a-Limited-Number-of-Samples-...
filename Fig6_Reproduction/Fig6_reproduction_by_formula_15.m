%% The reproduction of Figure 6 by formula (15)
...
%% figure
D = 1:1:Dmax;
figure('Name','Performance tradeoff of proposed and conventional filter estimators versus rank (M =30,N =40)'...
    ,'NumberTitle','off');
