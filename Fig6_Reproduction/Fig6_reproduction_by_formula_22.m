%% The reproduction of Figure 6 by formula (22)

clear;clc;close all;

M = 80; % number of demension
N = 100; % number of observed samples and estimators
K = 80; % number of interfering waveform
Dmax = 8;
timemax = 5; %% Set Average Times
...
%% figure
D = 1:1:Dmax;
figure('Name','Performance tradeoff of proposed and conventional filter estimators versus rank (M =80,N =100)'...
    ,'NumberTitle','off');
